    ...
    const MODULE_NOTES = {
      ...
      orders_user_deposit: { title: "用户押金", content: "运营商「订单与服务 → 用户押金」：按套餐单展示押金明细。<br>· 类型：实付押金 / 信用免押<br>· 状态：实付在押 / 退押中 / 已退押 / 信用免押<br>· 筛选项：套餐单号、手机、支付日、押金状态；支持分页<br>· 渠道担保不在本页；退押执行在「退款管理」" },
      ...
      rider_battery_deposit: { title: "骑手电池押金", content: "与「平台保证金」不同。<br>· 个人：购套餐<strong>同笔</strong>免押或实缴 → 运营商子商户<br>· 渠道人天：<strong>首次领电前</strong>免押或实缴（非静默渠道担保）<br>· 类型：实付在押 / 信用免押 / 渠道担保（租赁等 B 端）<br>· 运营商「订单与服务 → 用户押金」明细；「用户」台账；平台「用户管理 → 用户押金统计」只读汇总<br>· 数额见「定价管理 → 押金设置」；<strong>仅退押</strong>进「退款管理」" },
    ...
    const batteries = [
      ...
      { sn: "BAT-SH-1003", site: "陆家嘴分站", city: "上海", soc: 71, health: "正常", inCab: "CAB-22044", deviceOwnerId: "OP-SX", deviceOwnerName: "绿色出行" },
      { sn: "BAT-SH-1004", site: "浦东骑手驿站", city: "上海", soc: 63, health: "正常", inCab: "柜外-用户", heldByUser: true, holderName: "张骑手 138****6621", deviceOwnerId: "OP-SX", deviceOwnerName: "绿色出行" },
      { sn: "BAT-SH-1005", site: "世博换电服务点", city: "上海", soc: 85, health: "正常", inCab: "CAB-22021", deviceOwnerId: "OP-SX", deviceOwnerName: "绿色出行" },
      { sn: "BAT-SH-1006", site: "浦东骑手驿站", city: "上海", soc: 38, health: "正常", inCab: "CAB-22050", deviceOwnerId: "OP-SX", deviceOwnerName: "绿色出行" },
      { sn: "BAT-SH-1007", site: "浦东骑手驿站", city: "上海", soc: 55, health: "正常", inCab: "待入柜", deviceOwnerId: "OP-SX", deviceOwnerName: "绿色出行" },
      { sn: "BAT-SH-1008", site: "世博换电服务点", city: "上海", soc: 80, health: "正常", inCab: "CAB-33001", deviceOwnerId: "OP-SX", deviceOwnerName: "绿色出行" },
    ...
    const PF_DEFAULTS = {
      ...
      orders_user_deposit: { orderId: "", phone: "", payFrom: "", payTo: "", status: "全部" },
